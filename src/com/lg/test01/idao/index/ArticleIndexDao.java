package com.lg.test01.idao.index;
...
public class ArticleIndexDao {
	...
	/**
	 * 删除索引，根据id删除
	 * Term: 表示某个字段出现的某一个关键词（在索引库的目录中）
	 * Term term = new Term("title", "关键词");
	 * @param id
	 */
	...
	public void update(Article article) {
		...
		try {
			...
			indexWriter.updateDocument(term, ArticleDocumentUtils.articleToDocument(article)); //更新索引库(流程是先删除后添加，直接更新代价太大)
		} catch (Exception e) {
			throw new RuntimeException(e);
		} finally {
			// 关闭操作
